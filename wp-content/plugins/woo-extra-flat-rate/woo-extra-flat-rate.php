 ...
 * Description:       Advance Flat Rate Shipping Method For WooCommerce plugin is for add new flat rate option in your WooCommerce site. All Shipping option is display in Front side so User can choose shipping method based on that.
 * Version:           1.2
 * Author:            Multidots
...
// If this file is called directly, abort.n
if ( ! defined( 'WPINC' ) ) {
	die;
}
